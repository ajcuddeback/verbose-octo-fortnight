...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        // CSRF: enabled with CookieCsrfTokenRepository so Angular can read XSRF-TOKEN
        // and send it back as X-XSRF-TOKEN header automatically.
        // The Stripe webhook endpoint is excluded since it uses its own signature verification.
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowCredentials(true); // required to send/receive cookies cross-origin
